...
import 'package:akademik_app/Page/kota_tambah.dart';
import 'package:akademik_app/Page/siswa_edit.dart';
import 'package:akademik_app/Page/siswa_tambah.dart';
  ...
  void fetchDataSiswa(String query) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
            "https://krisad.000webhostapp.com/siswaapi/apilist?search=$query"),
        headers: {
          'Cookie': token,
        },
      );
