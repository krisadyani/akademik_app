...
class _SiswaEditState extends State<SiswaEdit> {
  ...
  Future<List<Map<String, dynamic>>> fetchKota() async {
    ...
    final response = await http.get(
      Uri.parse('https://krisad.000webhostapp.com/kotaapi/apilist'),
      headers: {
        'Cookie': token,
      },
    );
    if (response.statusCode == 200) {
      ...
      throw Exception("Gagal mengambil data kota dari database"); // PERLU CEK
    }
  }
  ...
  Future<void> siswaEdit() async {
    ...
    final response = await http.post(
      Uri.parse('https://krisad.000webhostapp.com/siswaapi/apiedit/$IdSiswa'),
      body: {
  ...
  Future<void> siswaDelete() async {
    ...
    final url = Uri.parse(
        'https://krisad.000webhostapp.com/siswaapi/apidelete/$idSiswa');
